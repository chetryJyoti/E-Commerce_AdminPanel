...
const Nav = ({ show }) => {
  ...
  const activeLink = inactiveLink + " bg-highlight text-black rounded-md py-1 ";
  ...
  return (
    <aside
      className={
        ...
        " top-0 p-4 text-gray-500 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"
      }
    >
